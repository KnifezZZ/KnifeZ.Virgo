...
namespace KnifeZ.Virgo.Mvc
{
    public static class FrameworkServiceExtension
    {
        ...
        )
        {
            ...
            // edit start by @vito
            services.TryAdd(ServiceDescriptor.Transient<IAuthorizationService, VirgoAuthorizationService>());
            ...
            var mvc = gd.AllAssembly.Where(x => x.ManifestModule.Name == "KnifeZ.Virgo.Mvc.dll").FirstOrDefault();
            var admin = gd.AllAssembly.Where(x => x.ManifestModule.Name == "KnifeZ.Virgo.Mvc.Admin.dll").FirstOrDefault();
            ...
            //            mvc,
            //            "KnifeZ.Virgo.Mvc" // your external assembly's base namespace
            //        )
            //    );
            //    }
            //    if (admin != null)
            ...
            //            new EmbeddedFileProvider(
            //                admin,
            //                "KnifeZ.Virgo.Mvc.Admin" // your external assembly's base namespace
            //            )
            //        );
            //    }
            //});
        ...
        private static List<FrameworkMenu> GetAllMenus(List<FrameworkModule> allModule)
        {
            ...
            var localizer = GlobalServices.GetService<IStringLocalizer<KnifeZ.Virgo.Core.Program>>();
            var menus = new List<FrameworkMenu>();
