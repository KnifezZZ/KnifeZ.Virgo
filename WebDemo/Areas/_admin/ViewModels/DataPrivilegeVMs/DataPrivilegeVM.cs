...
namespace KnifeZ.Virgo.Mvc.Admin.ViewModels.DataPrivilegeVMs
{
    public class DataPrivilegeVM : BaseCRUDVM<DataPrivilege>
    {
        ...
        protected override void InitVM()
        {
            ...
            {
                AllGroups = DC.Set<FrameworkGroup>().GetSelectListItems(KnifeVirgo, x => x.GroupName);
                TableNames = KnifeVirgo.DataPrivilegeSettings.ToListItems(x => x.PrivillegeName, x => x.ModelName);
            }
