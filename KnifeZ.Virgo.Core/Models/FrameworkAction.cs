...
namespace KnifeZ.Virgo.Core
{
    ...
    public class FrameworkAction : BasePoco
    {
        ...
        public string ActionName
        {
            get
            {
                if (ActionDes?.Localizer != null && string.IsNullOrEmpty(ActionDes?.Description) == false)
                {
                    if (ActionDes.Localizer[ActionDes.Description].ResourceNotFound == true)
                    {
                        return Core.Program._localizer[ActionDes.Description];
                    }
                    else
                    {
                        return ActionDes.Localizer[ActionDes.Description];
                    }
