...
namespace KnifeZ.Virgo.Core.Auth
{

    /// <summary>
    /// The default implementation of an <see cref="IAuthorizationService"/>.
    /// </summary>
    public class VirgoAuthorizationService : IAuthorizationService
    {
        ...
        /// <summary>
        /// Creates a new instance of <see cref="VirgoAuthorizationService"/>.
        /// </summary>
        ...
        public VirgoAuthorizationService (IAuthorizationPolicyProvider policyProvider, IAuthorizationHandlerProvider handlers, ILogger<VirgoAuthorizationService> logger, IAuthorizationHandlerContextFactory contextFactory, IAuthorizationEvaluator evaluator, IOptions<AuthorizationOptions> options)
        {
            if (options == null)
            {
    ...
    {
        private static readonly Action<ILogger, Exception> _userAuthorizationFailed;
        private static readonly Action<ILogger, Exception> _userAuthorizationSucceeded;
