            ...
            else
            {
                ...
                switch (this.DataType)
                {
                    ...
                    case ColumnDataType.DateTime:
                        ...
                        {
                            err = new ErrorMessage { Index = rowIndex, Message = CoreProgram.Callerlocalizer["{0}formaterror", this.ColumnName] };
                        }
                    ...
                    case ColumnDataType.Float:
                        ...
                        break;
                    case ColumnDataType.Bool:
                        if (value == CoreProgram.Callerlocalizer["Yes"])
                        {
                            this.Value = true;
                        }
                        else if (value == CoreProgram.Callerlocalizer["No"])
                        {
                            this.Value = false;
                        }
                        else
                    ...
                    case ColumnDataType.Enum:
                        ...
                        {
                            err = new ErrorMessage { Index = rowIndex, Message = CoreProgram.Callerlocalizer["{0}ValueNotExist", this.ColumnName] };
                        }
                        else
                        {
                        ...
                        break;
                    default:
                        err = new ErrorMessage { Index = rowIndex, Message = CoreProgram.Callerlocalizer["{0}ValueTypeNotAllowed", this.ColumnName] };
                        break;
                }
